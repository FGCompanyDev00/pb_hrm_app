...
//     Color homeBgColor = (_currentSection == 'Home' && _selectedIndex != 1)
//         ? Colors.orange
//         : isDarkMode
//         ? Colors.grey.shade800
//         : Colors.grey.shade200;

//     Color officeBgColor = (_currentSection == 'Office' && _selectedIndex != 1)
//         ? Colors.green
//         : isDarkMode
//         ? Colors.grey.shade800
//         : Colors.grey.shade200;

//     Color offsiteBgColor = _selectedIndex == 1
//         ? Colors.red
//         : isDarkMode
//         ? Colors.grey.shade800
//         : Colors.grey.shade200;

//     // Icon (image) color logic:
//     Color homeIconColor = (_currentSection == 'Home' && _selectedIndex != 1)
//         ? Colors.white
//         : (isDarkMode ? Colors.orange : Colors.orange);

//     Color officeIconColor = (_currentSection == 'Office' && _selectedIndex != 1)
//         ? Colors.white
//         : (isDarkMode ? Colors.green : Colors.green);

//     Color offsiteIconColor = _selectedIndex == 1
//         ? Colors.white
//         : (isDarkMode ? Colors.red : Colors.red);

//     // Text color logic:
//     Color homeTextColor = (_currentSection == 'Home' && _selectedIndex != 1)
//         ? Colors.white
//         : (isDarkMode ? Colors.white : Colors.black);

//     Color officeTextColor = (_currentSection == 'Office' && _selectedIndex != 1)
//         ? Colors.white
//         : (isDarkMode ? Colors.white : Colors.black);

//     Color offsiteTextColor = _selectedIndex == 1
//         ? Colors.white
//         : (isDarkMode ? Colors.white : Colors.black);

// select_processing_members.dart
...
class SelectProcessingMembersPage extends StatefulWidget {
  ...
  const SelectProcessingMembersPage({Key? key, required this.projectId}) : super(key: key);

  @override
  _SelectProcessingMembersPageState createState() => _SelectProcessingMembersPageState();
}

class _SelectProcessingMembersPageState extends State<SelectProcessingMembersPage> {

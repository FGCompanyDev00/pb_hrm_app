...
// //                 // If a valid image URL is provided, load the image from the URL
// //                 ? NetworkImage(imageUrl)
// //                 // Use a fallback image URL if no valid image URL is provided
// //                 : NetworkImage('https://demo-flexiflows-hr-employee-images.s3.ap-southeast-1.amazonaws.com/default_avatar.jpg'),
// //             onBackgroundImageError: (_, __) {
// //               // Fallback to an icon in case of any error loading the image
...
//                 const SizedBox(height: 10),
//                 // Display assigned members with images (with null check)
...
//                     return GestureDetector(
//                       onTap: () {
//                         // Show member name when avatar is clicked
//                         showDialog(
//                           context: context,
//                           builder: (BuildContext context) {
//                             return AlertDialog(
...
//               Wrap(
//                 spacing: 8.0,
//                 runSpacing: 8.0, // This will add some spacing vertically if needed
//                 children: _selectedPeople.map((person) {
//                   return Column(
...
//                               : const AssetImage('assets/default_avatar.png') as ImageProvider, // Placeholder image if none exists
//                         ),
//                       ),
//                       const SizedBox(height: 5), // Space between avatar and name
//                       Text(
//                         person['name'] ?? 'No Name',
//                         style: const TextStyle(fontSize: 12),
//                       ),

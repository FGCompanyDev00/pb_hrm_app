...
class _ProjectManagementPageState extends State<ProjectManagementPage> with SingleTickerProviderStateMixin {
  ...
  void _addMessage(String message) {
    setState(() {
      _messages.add({'time': DateFormat('hh:mm a').format(DateTime.now()), 'message': message});
    });
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _buildChatMessage(message['message']!, message['time']!, index % 2 == 0, isDarkMode);
            },
          ),
        ),
  ...
  Widget _buildChatMessage(String message, String time, bool isSentByMe, bool isDarkMode) {
    final Color textColor = isDarkMode ? Colors.white : Colors.black;
              ...
              DropdownButtonFormField<String>(
                ...
                items: ['Pending', 'Processing', 'Completed']
                  ...
                  return DropdownMenuItem<String>(
                    ...
                    child: Text(
                      value,
                      style: TextStyle(color: progressColors[value]),
                    ),
                  );
                }).toList(),
              ),

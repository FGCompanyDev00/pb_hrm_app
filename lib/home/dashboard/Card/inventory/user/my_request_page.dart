...
class _MyRequestPageState extends State<MyRequestPage> {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['results'] != null) {
          ...
          if (requests.isNotEmpty) {
            debugPrint('🔍 [MyRequestPage-User] First request data: ${requests[0]}');
            debugPrint('🔍 [MyRequestPage-User] First request img_path: ${requests[0]['img_path']}');
            debugPrint('🔍 [MyRequestPage-User] First request img_name: ${requests[0]['img_name']}');
          }
  ...
  Widget _buildRequestCard(Map<String, dynamic> request, bool isDarkMode) {
    ...
    // Debug logging
    debugPrint('🔍 [MyRequestPage-User] Request "$title" - img_path: "$imgPath", img_name: "$imgName", final URL: "$imageUrl"');

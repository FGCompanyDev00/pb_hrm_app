...
class _MyRequestDetailPageState extends State<MyRequestDetailPage> {
  ...
  bool get _isFinalStatus {
    ...
    if (s.contains('supervisor pending')) {
      debugPrint('🔍 [User] Status "$statusStr" is Supervisor Pending - NOT final status');
      return false;
    }
    ...
    debugPrint('🔍 [User] Status "$statusStr" isFinalStatus: $isFinal');
    return isFinal;
  }
  ...
  bool get _canEditItems {
    ...
    debugPrint('🔍 [User] Status: "$statusStr", Normalized: "$s", CanEditItems: $canEdit');
    return canEdit;
  }
  ...
  Future<void> _submitUpdate() async {
    ...
    try {
      ...
      debugPrint('🔍 [User] Update body: ${jsonEncode(body)}');
      ...
      debugPrint('🔍 [User] Update response status: ${response.statusCode}');
  ...
  Future<void> _submitCancel(String comment) async {
    ...
    try {
      ...
      debugPrint('🔍 [User] Cancel body: ${jsonEncode(body)}');
      ...
      debugPrint('🔍 [User] Cancel response status: ${response.statusCode}');
  ...
  Future<Widget> _buildFeedbackSection(bool isDarkMode) async {
    try {
      ...
      debugPrint('🔍 [User] Fetching feedback for topic: $topicUid');
      final response = await http.get(
      ...
      debugPrint('🔍 [User] Feedback response status: ${response.statusCode}');
      debugPrint('🔍 [User] Feedback response body: ${response.body}');
      ...
      debugPrint('🔍 [User] Approver image URL: $approverImageUrl');
      debugPrint('🔍 [User] Requester image URL: $requesterImageUrl');
      debugPrint('🔍 [User] Position name: $positionName');
      debugPrint('🔍 [User] Decide: $decide');
                        ...
                        child: approverImageUrl.isNotEmpty
                            ? Image.network(
                                ...
                                errorBuilder: (context, error, stackTrace) {
                                  debugPrint('🔍 [User] Approver image error: $error');
                                  return const Icon(
                                    Icons.person,
                                    color: Colors.green,
                                    size: 25,
                      ...
                      child: ClipOval(
                        child: requesterImageUrl.isNotEmpty
                            ? Image.network(
                                ...
                                fit: BoxFit.cover,
                                errorBuilder: (context, error, stackTrace) {
                                  debugPrint('🔍 [User] Requester image error: $error');
                                  return const Icon(
                                    Icons.person,
                                    color: Colors.green,
                                    size: 25,
      ...
      debugPrint('🔍 [User] Feedback error: $e');
      return const SizedBox.shrink();
    }
  }

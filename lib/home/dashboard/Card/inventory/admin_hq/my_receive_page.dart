...
/// My Receive page for AdminHQ users
/// Displays received items from the API endpoint
...
class _MyReceivePageState extends State<MyReceivePage> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['results'] != null) {
          ...
          setState(() {
            _receivedItems = List<Map<String, dynamic>>.from(
  ...
  void _openRequestorDetail(Map<String, dynamic> item) {
    // Add source field to identify this is from My Receive page
                      ...
                      : RefreshIndicator(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return _buildReceivedItemCard(item, isDarkMode);
                            },
                          ),
                        ),
        );
  ...
  Widget _buildReceivedItemCard(Map<String, dynamic> item, bool isDarkMode) {
    final String title = item['title'] ?? 'No Title';
    final String requestorName = item['requestor_name'] ?? 'Unknown';
    ...
    final String rawImageUrl = item['img_path'] ?? item['img_name'] ?? '';
    ...
    return Container(
      ...
      child: InkWell(
        onTap: () => _openRequestorDetail(item),
        borderRadius: BorderRadius.circular(12),
        child: Padding(
          padding: const EdgeInsets.all(16),
          child: Row(

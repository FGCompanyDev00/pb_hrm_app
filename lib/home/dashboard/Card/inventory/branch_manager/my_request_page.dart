...
/// My Request page for Branch_manager role
/// Displays a list of inventory requests made by the current branch manager
...
class _MyRequestPageState extends State<MyRequestPage> {
  ...
  /// Fetch inventory requests for the current branch manager

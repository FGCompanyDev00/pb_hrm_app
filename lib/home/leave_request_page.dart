  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        flexibleSpace: Image.asset(
          'assets/ready_bg.png', // Image for the AppBar background
          fit: BoxFit.cover,
        ),
        backgroundColor: Colors.transparent, // Make AppBar transparent to show image
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Align(
                alignment: Alignment.centerRight, // Align the Add button to the right

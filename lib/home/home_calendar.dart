...
//                 ),
//               ),
//               // New section: Display leave events below the calendar
//               Expanded(
//                 child: Container(
//                   decoration: BoxDecoration(
//                     image: DecorationImage(
...
//                             subtitle: Text(
//                                 'From: ${leaveRequest['take_leave_from']} To: ${leaveRequest['take_leave_to']} (${leaveRequest['days']} days)'),
//                             trailing: Icon(
//                               Icons.circle,
//                               color: leaveRequest['is_approve'] == 'Approved'
//                                   ? Colors.green
//                                   : leaveRequest['is_approve'] == 'Rejected'
//                                       ? Colors.red
//                                       : Colors.orange,
//                             ),
//                           ),
...
//   // }
// void _showDayView(DateTime date) {
//   final events = _getEventsForDay(date); // Fetch events for the selected day
//   Navigator.push(
//     context,
//     MaterialPageRoute(
//       builder: (context) => DayViewScreen(date: date, events: events),
...
//                                     const SizedBox(height: 4),
//                                     Text(
//                                       'From: ${leaveRequest['take_leave_from']} To: ${leaveRequest['take_leave_to']}',
//                                       style: TextStyle(
//                                         fontSize: 14,
...
class _HomeCalendarState extends State<HomeCalendar> {
  ...
  void _showDayView(DateTime date) {
    final events = _getEventsForDay(date);
    print("Navigating to day view with events: $events"); // Log for debugging
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => DayViewScreen(date: date, events: events),
  ...
  void _addEvent(String title, DateTime startDateTime, DateTime endDateTime, String description, String status, bool isMeeting) {
    ...
    print("Added new event: $newEvent for day: $_selectedDay");
  }
...
class DayViewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print("Building DayViewScreen for date: $date with events: $events");

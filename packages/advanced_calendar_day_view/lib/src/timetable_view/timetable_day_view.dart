...
import 'widgets/timetable_list_view_row.dart';
...
class TimeTableDayView extends StatefulWidget {
  ...
  final TimeViewItemBuilder? timeViewItemBuilder;
  ...
  final List<OverTimeEventsRow> overflowEvents;

  @override
  State<TimeTableDayView> createState() => _TimeTableDayViewState();
}

class _TimeTableDayViewState<T extends Object> extends State<TimeTableDayView> {
  ...
  @override
  void didUpdateWidget(covariant TimeTableDayView oldWidget) {
    ...
    return [
      for (final oEvents in widget.overflowEvents)
        Positioned(
          ...
          child: TimeTableViewRow(
            totalHeight: totalHeight,
            oEvents: oEvents,
            ignored: widget.onTimeTap != null,
            timeViewItemBuilder: widget.timeViewItemBuilder!,

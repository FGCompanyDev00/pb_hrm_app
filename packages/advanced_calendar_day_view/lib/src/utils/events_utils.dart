...
/// From List of AdvancedDayEvent process them into multiple OverflowEventRow
///
/// where each row contains multiple AdvancedDayEvent that happen overlap each other
